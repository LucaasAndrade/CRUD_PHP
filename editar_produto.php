<?php
    ...
    // SE NÃO ESTÁ DEFINIDO ADM_LOGADO, REDIRECIONAR PARA LOGIN
...
<body>
    ...
    <form action="editar_produto.php" method="post">
        ...
        <textarea name="descricao" id="descricao" value="<?php echo $produto['descricao'];?>" ></textarea><br>
    ...
    <a href="listar_produtos.php"> Voltar à lista de produtos </a>ç
</body>
</html>